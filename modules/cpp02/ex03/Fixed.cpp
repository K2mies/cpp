...
/*converts a float to fixed-point value and stores it in the object*/
void	Fixed::floatToFixed(const float floatValue)
{
	this->_rawBits = static_cast<int>(roundf(floatValue * static_cast<float>(1 << Fixed::_bits)));
	
}
/*converts an int to fixed-point value and stores it in the object*/
void	Fixed::intToFixed(const int	intValue)
{
