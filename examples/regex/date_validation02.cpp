...
bool	isValidDate(std::smatch const matches);

int	main()
{
//	std::string line = "2023-11-15,11.47"; //valid date
//	std::string line = "2023-15-15,11.47"; //invalid date
//	std::string line = "test1-15-15,11.47"; //invalid input
	std::string line = "test1 2023-15-15,11.47"; //invalid input
